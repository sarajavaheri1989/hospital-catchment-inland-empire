...
| CDC PLACES Census Tract Data (GIS-Friendly Format), 2024 release | Centers for Disease Control and Prevention | [Source page](https://catalog.data.gov/dataset/places-census-tract-data-gis-friendly-format-2024-release) | [Download](https://data.cdc.gov/api/v3/views/yjkw-uj5s/export.csv?accessType=DOWNLOAD) | Public; ODbL license |

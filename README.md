...
| CDC PLACES Census Tract Data (GIS-Friendly Format), 2024 release | Centers for Disease Control and Prevention | [Source page](https://catalog.data.gov/dataset/places-census-tract-data-gis-friendly-format-2024-release) | [Download](https://catalog.data.gov/dataset/places-census-tract-data-gis-friendly-format-2024-release) | Public; ODbL license |
...
3. Request a free U.S. Census Bureau API key at [api.census.gov](https://api.census.gov/data/key_signup.html) and set it as an environment variable:### Citations
